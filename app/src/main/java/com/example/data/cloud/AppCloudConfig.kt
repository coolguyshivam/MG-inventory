...
object AppCloudConfig {
    ...
    const val COLL_BRAND_STOCK_ITEMS = "brand_stock_items"
    const val COLL_BRAND_STOCK_TRANSACTIONS = "brand_stock_transactions"
    const val COLL_BRAND_VARIANTS = "brand_variants"
